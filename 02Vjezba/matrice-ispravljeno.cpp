...
matrica zbroji_matrice(const matrica& matrix1, const matrica& matrix2)
{
...
matrica oduzmi_matrice(const matrica& matrix1, const matrica& matrix2)
{
    if (matrix1.retci != matrix2.retci || matrix1.stupci != matrix2.stupci)
    {
...
matrica pomnozi_matrice(const matrica& matrix1, const matrica& matrix2)
{
...
matrica transponiraj_matricu(const matrica& matrix)
{
...
void ispisivanje_matrice(const matrica& matrix)
{
    for (int i = 0; i < matrix.retci; i++)
    {
        for (int j = 0; j < matrix.stupci; j++)
